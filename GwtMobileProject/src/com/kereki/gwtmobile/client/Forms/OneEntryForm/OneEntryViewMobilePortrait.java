...
public class OneEntryViewMobilePortrait extends View implements OneEntryDisplay {

  interface ViewUiBinder extends UiBinder<Widget, OneEntryViewMobilePortrait> {
  }
  ...
  public OneEntryViewMobilePortrait() {
